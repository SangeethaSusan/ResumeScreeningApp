...
model = joblib.load(r"C:\Users\admin\Projects\Resume\linear_svc_model.pkl")         # Your trained Linear SVC
vectorizer = joblib.load(r"C:\Users\admin\Projects\Resume\tfidf_vectorizer.pkl")    # The TF-IDF vectorizer used in training
